...
test('TanakhYomiEvent', () => {
  ...
  expect(ev.render('he')).toBe('יְשַׁעְיָהוּ ס׳ כ״ג');
  expect(ev.render('he-x-NoNikud')).toBe('ישעיהו ס׳ כ״ג');
...
test('TanakhYomiEvent-2', () => {
  ...
  expect(ev.render('he')).toBe('תרי עשר ס׳ ט״ו');
...
test('TanakhYomiEvent-3', () => {
  ...
  expect(ev.render('he')).toBe('דִברֵי הַיָמִים ס׳ כ״א');
...
test('TanakhYomi.render', () => {
  ...
  const expected = {
    ...
    '2027-10-05': 'דִברֵי הַיָמִים ס׳ י״א',
    '2027-10-06': 'דִברֵי הַיָמִים ס׳ י״ב',
    '2027-10-07': 'דִברֵי הַיָמִים ס׳ י״ג',
    '2027-10-08': 'דִברֵי הַיָמִים ס׳ י״ד',
    '2027-10-09': null,
    '2027-10-10': 'דִברֵי הַיָמִים ס׳ ט״ו',
    '2027-10-11': null,
    '2027-10-12': 'דִברֵי הַיָמִים ס׳ ט״ז',
    '2027-10-13': 'דִברֵי הַיָמִים ס׳ י״ז',
    '2027-10-14': 'דִברֵי הַיָמִים ס׳ י״ח',
    '2027-10-15': 'דִברֵי הַיָמִים ס׳ י״ט',
    '2027-10-16': null,
    '2027-10-17': 'דִברֵי הַיָמִים ס׳ כ׳',
    '2027-10-18': 'דִברֵי הַיָמִים ס׳ כ״א',
    '2027-10-19': 'דִברֵי הַיָמִים ס׳ כ״ב',
    '2027-10-20': 'דִברֵי הַיָמִים ס׳ כ״ג',
    '2027-10-21': 'דִברֵי הַיָמִים ס׳ כ״ד',
    '2027-10-22': 'דִברֵי הַיָמִים ס׳ כ״ה',
    '2027-10-23': null,
    '2027-10-24': 'יְהוֹשׁוּעַ ס׳ א׳',
    '2027-10-25': 'יְהוֹשׁוּעַ ס׳ ב׳',
    '2027-10-26': 'יְהוֹשׁוּעַ ס׳ ג׳',
    '2027-10-27': 'יְהוֹשׁוּעַ ס׳ ד׳',
    '2027-10-28': 'יְהוֹשׁוּעַ ס׳ ה׳',
    '2027-10-29': 'יְהוֹשׁוּעַ ס׳ ו׳',
    '2027-10-30': null,
    '2027-10-31': 'יְהוֹשׁוּעַ ס׳ ז׳',
    '2027-11-01': 'יְהוֹשׁוּעַ ס׳ ח׳',
    '2027-11-02': 'יְהוֹשׁוּעַ ס׳ ט׳',
    '2027-11-03': 'יְהוֹשׁוּעַ ס׳ י׳',
    '2027-11-04': 'יְהוֹשׁוּעַ ס׳ י״א',
    '2027-11-05': 'יְהוֹשׁוּעַ ס׳ י״ב',
    '2027-11-06': null,
    '2027-11-07': 'יְהוֹשׁוּעַ ס׳ י״ג',
    '2027-11-08': 'יְהוֹשׁוּעַ ס׳ י״ד',
    ...
    '2027-11-20': null,
    '2027-11-21': 'שׁוֹפְטִים ס׳ י״א',
    '2027-11-22': 'שׁוֹפְטִים ס׳ י״ב',
    '2027-11-23': 'שׁוֹפְטִים ס׳ י״ג',
    '2027-11-24': 'שׁוֹפְטִים ס׳ י״ד',
    ...
    '2027-12-07': 'שְׁמוּאֵל ס׳ י״א',
    '2027-12-08': 'שְׁמוּאֵל ס׳ י״ב',
    '2027-12-09': 'שְׁמוּאֵל ס׳ י״ג',
    '2027-12-10': 'שְׁמוּאֵל ס׳ י״ד',
    '2027-12-11': null,
    '2027-12-12': 'שְׁמוּאֵל ס׳ ט״ו',
    '2027-12-13': 'שְׁמוּאֵל ס׳ ט״ז',
    '2027-12-14': 'שְׁמוּאֵל ס׳ י״ז',
    '2027-12-15': 'שְׁמוּאֵל ס׳ י״ח',
    '2027-12-16': 'שְׁמוּאֵל ס׳ י״ט',
    '2027-12-17': 'שְׁמוּאֵל ס׳ כ׳',
    '2027-12-18': null,
    '2027-12-19': 'שְׁמוּאֵל ס׳ כ״א',
    '2027-12-20': 'שְׁמוּאֵל ס׳ כ״ב',
    '2027-12-21': 'שְׁמוּאֵל ס׳ כ״ג',
    '2027-12-22': 'שְׁמוּאֵל ס׳ כ״ד',
    '2027-12-23': 'שְׁמוּאֵל ס׳ כ״ה',
    '2027-12-24': 'שְׁמוּאֵל ס׳ כ״ו',
    '2027-12-25': null,
    '2027-12-26': 'שְׁמוּאֵל ס׳ כ״ז',
    '2027-12-27': 'שְׁמוּאֵל ס׳ כ״ח',
    '2027-12-28': 'שְׁמוּאֵל ס׳ כ״ט',
    '2027-12-29': 'שְׁמוּאֵל ס׳ ל׳',
    '2027-12-30': 'שְׁמוּאֵל ס׳ ל״א',
    '2027-12-31': 'שְׁמוּאֵל ס׳ ל״ב',
    '2028-01-01': null,
    '2028-01-02': 'שְׁמוּאֵל ס׳ ל״ג',
    '2028-01-03': 'שְׁמוּאֵל ס׳ ל״ד',
    ...
    '2028-01-15': null,
    '2028-01-16': 'מְלָכִים ס׳ י״א',
    '2028-01-17': 'מְלָכִים ס׳ י״ב',
    '2028-01-18': 'מְלָכִים ס׳ י״ג',
    '2028-01-19': 'מְלָכִים ס׳ י״ד',
    '2028-01-20': 'מְלָכִים ס׳ ט״ו',
    '2028-01-21': 'מְלָכִים ס׳ ט״ז',
    '2028-01-22': null,
    '2028-01-23': 'מְלָכִים ס׳ י״ז',
    '2028-01-24': 'מְלָכִים ס׳ י״ח',
    '2028-01-25': 'מְלָכִים ס׳ י״ט',
    '2028-01-26': 'מְלָכִים ס׳ כ׳',
    '2028-01-27': 'מְלָכִים ס׳ כ״א',
    '2028-01-28': 'מְלָכִים ס׳ כ״ב',
    '2028-01-29': null,
    '2028-01-30': 'מְלָכִים ס׳ כ״ג',
    '2028-01-31': 'מְלָכִים ס׳ כ״ד',
    '2028-02-01': 'מְלָכִים ס׳ כ״ה',
    '2028-02-02': 'מְלָכִים ס׳ כ״ו',
    '2028-02-03': 'מְלָכִים ס׳ כ״ז',
    '2028-02-04': 'מְלָכִים ס׳ כ״ח',
    '2028-02-05': null,
    '2028-02-06': 'מְלָכִים ס׳ כ״ט',
    '2028-02-07': 'מְלָכִים ס׳ ל׳',
    '2028-02-08': 'מְלָכִים ס׳ ל״א',
    '2028-02-09': 'מְלָכִים ס׳ ל״ב',
    '2028-02-10': 'מְלָכִים ס׳ ל״ג',
    '2028-02-11': 'מְלָכִים ס׳ ל״ד',
    '2028-02-12': null,
    '2028-02-13': 'מְלָכִים ס׳ ל״ה',
    ...
    '2028-02-25': 'יְשַׁעְיָהוּ ס׳ י״א',
    '2028-02-26': null,
    '2028-02-27': 'יְשַׁעְיָהוּ ס׳ י״ב',
    '2028-02-28': 'יְשַׁעְיָהוּ ס׳ י״ג',
    '2028-02-29': 'יְשַׁעְיָהוּ ס׳ י״ד',
    '2028-03-01': 'יְשַׁעְיָהוּ ס׳ ט״ו',
    '2028-03-02': 'יְשַׁעְיָהוּ ס׳ ט״ז',
    '2028-03-03': 'יְשַׁעְיָהוּ ס׳ י״ז',
    '2028-03-04': null,
    '2028-03-05': 'יְשַׁעְיָהוּ ס׳ י״ח',
    '2028-03-06': 'יְשַׁעְיָהוּ ס׳ י״ט',
    '2028-03-07': 'יְשַׁעְיָהוּ ס׳ כ׳',
    '2028-03-08': 'יְשַׁעְיָהוּ ס׳ כ״א',
    '2028-03-09': 'יְשַׁעְיָהוּ ס׳ כ״ב',
    '2028-03-10': 'יְשַׁעְיָהוּ ס׳ כ״ג',
    '2028-03-11': null,
    '2028-03-12': null,
    '2028-03-13': 'יְשַׁעְיָהוּ ס׳ כ״ד',
    '2028-03-14': 'יְשַׁעְיָהוּ ס׳ כ״ה',
    '2028-03-15': 'יְשַׁעְיָהוּ ס׳ כ״ו',
    ...
    '2028-03-28': 'יִרְמְיָהוּ ס׳ י״א',
    '2028-03-29': 'יִרְמְיָהוּ ס׳ י״ב',
    '2028-03-30': 'יִרְמְיָהוּ ס׳ י״ג',
    '2028-03-31': 'יִרְמְיָהוּ ס׳ י״ד',
    '2028-04-01': null,
    '2028-04-02': 'יִרְמְיָהוּ ס׳ ט״ו',
    '2028-04-03': 'יִרְמְיָהוּ ס׳ ט״ז',
    '2028-04-04': 'יִרְמְיָהוּ ס׳ י״ז',
    '2028-04-05': 'יִרְמְיָהוּ ס׳ י״ח',
    '2028-04-06': 'יִרְמְיָהוּ ס׳ י״ט',
    '2028-04-07': 'יִרְמְיָהוּ ס׳ כ׳',
    '2028-04-08': null,
    '2028-04-09': 'יִרְמְיָהוּ ס׳ כ״א',
    '2028-04-10': 'יִרְמְיָהוּ ס׳ כ״ב',
    '2028-04-11': null,
    '2028-04-12': 'יִרְמְיָהוּ ס׳ כ״ג',
    '2028-04-13': 'יִרְמְיָהוּ ס׳ כ״ד',
    '2028-04-14': 'יִרְמְיָהוּ ס׳ כ״ה',
    '2028-04-15': null,
    '2028-04-16': 'יִרְמְיָהוּ ס׳ כ״ו',
    '2028-04-17': null,
    '2028-04-18': 'יִרְמְיָהוּ ס׳ כ״ז',
    '2028-04-19': 'יִרְמְיָהוּ ס׳ כ״ח',
    '2028-04-20': 'יִרְמְיָהוּ ס׳ כ״ט',
    '2028-04-21': 'יִרְמְיָהוּ ס׳ ל׳',
    '2028-04-22': null,
    '2028-04-23': 'יִרְמְיָהוּ ס׳ ל״א',
    ...
    '2028-05-06': null,
    '2028-05-07': 'יְחֶזְקֵאל ס׳ י״א',
    '2028-05-08': 'יְחֶזְקֵאל ס׳ י״ב',
    '2028-05-09': 'יְחֶזְקֵאל ס׳ י״ג',
    '2028-05-10': 'יְחֶזְקֵאל ס׳ י״ד',
    '2028-05-11': 'יְחֶזְקֵאל ס׳ ט״ו',
    '2028-05-12': 'יְחֶזְקֵאל ס׳ ט״ז',
    '2028-05-13': null,
    '2028-05-14': 'יְחֶזְקֵאל ס׳ י״ז',
    '2028-05-15': 'יְחֶזְקֵאל ס׳ י״ח',
    '2028-05-16': 'יְחֶזְקֵאל ס׳ י״ט',
    '2028-05-17': 'יְחֶזְקֵאל ס׳ כ׳',
    '2028-05-18': 'יְחֶזְקֵאל ס׳ כ״א',
    '2028-05-19': 'יְחֶזְקֵאל ס׳ כ״ב',
    '2028-05-20': null,
    '2028-05-21': 'יְחֶזְקֵאל ס׳ כ״ג',
    '2028-05-22': 'יְחֶזְקֵאל ס׳ כ״ד',
    '2028-05-23': 'יְחֶזְקֵאל ס׳ כ״ה',
    '2028-05-24': 'יְחֶזְקֵאל ס׳ כ״ו',
    '2028-05-25': 'יְחֶזְקֵאל ס׳ כ״ז',
    '2028-05-26': 'יְחֶזְקֵאל ס׳ כ״ח',
    '2028-05-27': null,
    '2028-05-28': 'יְחֶזְקֵאל ס׳ כ״ט',
    '2028-05-29': 'תרי עשר ס׳ א׳',
    '2028-05-30': 'תרי עשר ס׳ ב׳',
    '2028-05-31': null,
    '2028-06-01': 'תרי עשר ס׳ ג׳',
    '2028-06-02': 'תרי עשר ס׳ ד׳',
    '2028-06-03': null,
    '2028-06-04': 'תרי עשר ס׳ ה׳',
    '2028-06-05': 'תרי עשר ס׳ ו׳',
    '2028-06-06': 'תרי עשר ס׳ ז׳',
    '2028-06-07': 'תרי עשר ס׳ ח׳',
    '2028-06-08': 'תרי עשר ס׳ ט׳',
    '2028-06-09': 'תרי עשר ס׳ י׳',
    '2028-06-10': null,
    '2028-06-11': 'תרי עשר ס׳ י״א',
    '2028-06-12': 'תרי עשר ס׳ י״ב',
    '2028-06-13': 'תרי עשר ס׳ י״ג',
    '2028-06-14': 'תרי עשר ס׳ י״ד',
    '2028-06-15': 'תרי עשר ס׳ ט״ו',
    '2028-06-16': 'תרי עשר ס׳ ט״ז',
    '2028-06-17': null,
    '2028-06-18': 'תרי עשר ס׳ י״ז',
    '2028-06-19': 'תרי עשר ס׳ י״ח',
    '2028-06-20': 'תרי עשר ס׳ י״ט',
    '2028-06-21': 'תרי עשר ס׳ כ׳',
    '2028-06-22': 'תרי עשר ס׳ כ״א',
    ...
    '2028-07-05': 'תְּהִלִּים ס׳ י״א',
    '2028-07-06': 'תְּהִלִּים ס׳ י״ב',
    '2028-07-07': 'תְּהִלִּים ס׳ י״ג',
    '2028-07-08': null,
    '2028-07-09': 'תְּהִלִּים ס׳ י״ד',
    '2028-07-10': 'תְּהִלִּים ס׳ ט״ו',
    '2028-07-11': 'תְּהִלִּים ס׳ ט״ז',
    '2028-07-12': 'תְּהִלִּים ס׳ י״ז',
    '2028-07-13': 'תְּהִלִּים ס׳ י״ח',
    '2028-07-14': 'תְּהִלִּים ס׳ י״ט',
    '2028-07-15': null,
    ...
    '2028-08-04': 'שִׁיר הַשִּׁירִים ס׳ א׳1',
    '2028-08-05': null,
    '2028-08-06': 'שִׁיר הַשִּׁירִים ס׳ א׳2',
    '2028-08-07': 'רוּת ס׳ א׳1',
    '2028-08-08': 'רוּת ס׳ א׳2',
