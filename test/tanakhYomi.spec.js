...
test('TanakhYomiEvent-2', () => {
  ...
  expect(ev.render('he')).toBe('תרי עשר ס׳ טו');
...
test('TanakhYomi.render', () => {
  ...
  const expected = {
    ...
    '2027-11-04': 'יְהוֹשׁוּעַ ס׳ יא',
    '2027-11-05': 'יְהוֹשׁוּעַ ס׳ יב',
    '2027-11-06': null,
    '2027-11-07': 'יְהוֹשׁוּעַ ס׳ יג',
    '2027-11-08': 'יְהוֹשׁוּעַ ס׳ יד',
    ...
    '2028-06-10': null,
    '2028-06-11': 'תרי עשר ס׳ יא',
    '2028-06-12': 'תרי עשר ס׳ יב',
    '2028-06-13': 'תרי עשר ס׳ יג',
    '2028-06-14': 'תרי עשר ס׳ יד',
    '2028-06-15': 'תרי עשר ס׳ טו',
    '2028-06-16': 'תרי עשר ס׳ טז',
    '2028-06-17': null,
    '2028-06-18': 'תרי עשר ס׳ יז',
    '2028-06-19': 'תרי עשר ס׳ יח',
    '2028-06-20': 'תרי עשר ס׳ יט',
    '2028-06-21': 'תרי עשר ס׳ כ',
    '2028-06-22': 'תרי עשר ס׳ כא',
